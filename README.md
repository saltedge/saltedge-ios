...
The current version of the SDK is [2.5.3](https://github.com/saltedge/saltedge-ios/releases/tag/v2.5.3), and is in compliance with the Salt Edge API's [current version](https://docs.saltedge.com/#version_management). Any backward-incompatible changes in the API will result in changes to the SDK.
