...
The current version of the SDK is [3.2.1](https://github.com/saltedge/saltedge-ios/releases/tag/v3.2.1), and is in compliance with the Salt Edge API's [current version](https://docs.saltedge.com/guides/versioning/). Any backward-incompatible changes in the API will result in changes to the SDK.
