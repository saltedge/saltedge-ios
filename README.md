...
The current version of the SDK is [3.1.3](https://github.com/saltedge/saltedge-ios/releases/tag/v3.1.3), and is in compliance with the Salt Edge API's [current version](https://docs.saltedge.com/guides/versioning/). Any backward-incompatible changes in the API will result in changes to the SDK.
